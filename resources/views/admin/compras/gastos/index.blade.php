            ...
            <div class="card-body" style="padding: 0;">
                <div class="col-sm-12" style="padding: 10px 0; overflow: hidden;">
                    ...
                    <div class="col-md-3 col-sm-3" style="float: left;">
                        <div class="input-group input-group-sm">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="basic-addon1">Condicíon</span>
                            </div>
                            <select name="condicion" id="condicion" class="mr-3 form-control form-control-sm col-12">
...
@section('js')
    ...
    <script>
        ...
        var buttons_data = {
            ...
            title: 'Gastos',
            table: 'tablaListado',
            newUrl: '{{ route('admin.gastos.create') }}',
        };
        var espanis_data = {
        ...
        function getListado(){
            var _url = 'gastos/datatable?desde='+$('#desde').val()+'&hasta='+$('#hasta').val()+'&condicion='+$('#condicion').val();
            // var _url = 'gastos/datatable';
            ...
            var childRows = null;
             ...
             table = $('#tablaListado').DataTable({
                 ...
                 columns: [
                    {
                        // "className":      'details-control dtr-control',
                        "orderable":      false,
                        "data":           null,
                        "defaultContent": '',
                        "label":"#"
                    ...
                    { "data": "fecha", "title":"Fecha", "className": 'details-control', width: '150px' },
                    { "data": "proveedor.persona.name", "title":"Proveedor", "className": 'details-control', width: '150px' },
                    { "data": "cuenta.name", "title":"Cuenta", "className": 'details-control' },
                    { "data": "condicion.name", "title":"Condicion", "className":"details-control" },
                    { "data": "total", "title":"Total", "className":"dt-right details-control" },
                    { "data": "saldo", "title":"Saldo", "className":"dt-right details-control" },
                ...
                //     var valComision = Math.round( (comTotal + Number.EPSILON) * 100 ) / 100;
                //     var comision = ''+valComision;

                //     $( api.column( 5 ).footer() ).html('Total');
                //     $( api.column( 6 ).footer() ).html(  comTotal  );

                //     $( api.column( 7 ).footer() ).html( getFormatGS( bruTotal ) );
                //     $( api.column( 8 ).footer() ).html( getFormatGS( desTotal ) );
                //     $( api.column( 9 ).footer() ).html( getFormatGS( monTotal ) );
                // },
            });
            ...
            if(!isMobile){
                ...
                //
                    if ( row.child.isShown() ) {
                        //console.log('mal entra');
                        row.child.hide();
                        tr.removeClass('shown');
                    }else {
                        // Open this row
                        //console.log('bien entra');
...
<style>
    /* td.details-control-img {
        background: url({{ asset('/css/img/details_open.png') }}) no-repeat center center;
        cursor: pointer;
        background-size: 30px 30px;
    }
    tr.shown td.details-control-img {
        background: url({{ asset('/css/img/details_close.png') }}) no-repeat center center;
        background-size: 30px 30px;
    } */
    td.details-control {
        cursor: pointer;
