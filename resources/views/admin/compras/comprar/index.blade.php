...
@section('js')
    ...
    <script>
        ...
        var table;
        var buttons_data = {
            messageTop: 'Compras registrados',
            messageBottom: 'Francisco Noceda',
            filename: 'compras',
            title: 'Compras',
            table: 'tablaListado',
            newUrl: '{{ route('admin.compras.create') }}',
        };
        var espanis_data = {
        ...
        function getListado(){
            var _url = 'compras/datatable?desde='+$('#desde').val()+'&hasta='+$('#hasta').val()+'&condicion='+$('#condicion').val();
