<div class="card shadow mb-3 col-md-12 text-black bg-info">
    <div class="card-header">
        <h3>Historial del Profesional</h3>
        Seleccione un Profesional para comenzar
    </div>
    <div class="card-body">
        <form>
            ...
            <div class="form-row mb-1 mt-1">
                <div class="col-2">
                    <x-jet-label value="Profesional:" />
                </div>
                <div class="col-4">
                    <select class="form-control select2"  name="profesional" id="profesional">
