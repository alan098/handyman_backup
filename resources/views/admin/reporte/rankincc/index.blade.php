...
@section('content')
    ...
    @include('admin.reporte.rankincc.filtro')
    @include('admin.reporte.rankincc.data')
    <br>
@stop
...
var _urlmodal = "{{ route('admin.reporte.clientes.cc.data') }}";
    var data = {
        table: "table_data",
        ajax : _urlmodal,
        topMsg: "",
        ...
        title: 'Listado',
        columns: [
            {data: 'fecha', name: 'fecha', title: 'Fecha Cancelacion',class: 'noexport dt-center'},
            {data: 'dias', name: 'dias', title: 'Dias que pasaron de la cancelacion',class: 'noexport dt-center'},
            {data: 'cliente', name: 'cliente', title: 'Cliente',class: 'noexport dt-center'},
            {data: 'estado', name: 'estado', title: 'Estado',class: 'noexport dt-center'},
            {data: 'acciones', name: 'acciones', title: 'Hitorial Cliente',class: 'noexport dt-center'},
        ]
    };
    toDataTablefa(data)
