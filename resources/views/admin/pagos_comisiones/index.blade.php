    ...
    <div>
        <div class="card">
            <div class="card-header">
                <h4 class="float-left">Cuentas Por Servicios</h4>
    ...
    <div class="modal fade bd-example-modal-lg" id="comprobantesProveedor" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <form action="{{ route('admin.pagos.comisiones.nuevo') }}" method="POST">
                ...
                <input type="hidden" id="tipo_persona" name="tipo_persona" value="colaborador">
...
@section('js')
    ...
    <script>
        ...
        function marcarTodos(che){
            if ($(che).prop('checked')) {
                var urldetall = "{{ url('admin/pagos/comisiones/data') }}" + '?colaborador_id='+$('#pid').val();
