        ...
        <form id="formCrud">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="formCrudModalTitle">Nuevo Producto</h5>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-sm" id="codigo" name="codigo" autofocus>
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-group">
                        ...
                        <div class="col">
                            <div class="form-group">
                                <label for="precio" class="col-form-label">Precio de Venta: <small>(<span
                                            class="text-danger">*</span>)</small></label>
                                <input type="text" class="form-control form-control-sm" id="precio" name="precio" value="0"
                                    required>
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-sm" id="costo" name="costo" value="0">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="custom-control custom-radio">
                                <input class="custom-control-input" type="radio" id="iva10" name="iva" value="10" checked>
                                <label for="iva10" class="custom-control-label">Iva 10%</label>
                            </div>
                        </div>
                        <div class="col">
                            <div class="custom-control custom-radio">
                                <input class="custom-control-input" type="radio" id="iva5" name="iva" value="5">
                                <label for="iva5" class="custom-control-label">Iva 5%</label>
                            </div>
                        </div>
                        <div class="col">
                            <div class="custom-control custom-radio">
                                <input class="custom-control-input" type="radio" id="excenta" name="iva" value="0">
...
<script>
    ...
    $('#formCrud').on('submit', function(e){
        ...
        if( $('#id').val()  ){
            ...
            var ruta = "{{ route('admin.productos.update') }}";
            var formData = new FormData($('#formCrud')[0]);
            update(formData, ruta);
        }else{
            console.log('store');
            var formData = new FormData($('#formCrud')[0]);
            var ruta = "{{ route('admin.productos.store') }}";
            store(formData, ruta);
        }
        console.log(ruta);
    });
