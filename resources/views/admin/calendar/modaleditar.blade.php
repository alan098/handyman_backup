                            ...
                            <div class="row">
                                <div class="col-lg-6 mr-1">
                                    ...
                                    <div class="form-row mb-1">
                                        ...
                                        <div class="col-8">
                                            <textarea
                                                ...
                                                rows="2" name="descripcion" id="edit_descripcion" >
                                                    </textarea>
                                        </div>
                                    </div>
                                    <style>
                                    ...
                                    <div class="form-row mb-1">
                                        ...
                                        {{-- <div class="col-7">
                                            <h5>Sin Preferencia -></h5>
                                        </div>
                                        <div class="col-5">
                                            <div class="form-check">
                                                <input class="form-check-input big-checkbox" type="checkbox" value="true" id="sin_prefe" name="sin_prefe">
                                            </div>
                                        </div> --}}
                                    </div>
                                </div>
