...
@section('content_header')
   <div class="mt-n1">Inventarios</div>
@stop
            ...
            <div class="card-body" style="padding: 0;">
                <div class="col-sm-12" style="padding: 10px 0; overflow: hidden;">
                    ...
                    <div class="col-md-3 col-sm-3" style="float: left;">
                        <div class="input-group input-group-sm">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="basic-addon1">Entidad</span>
                            </div>
                            <select name="entidad" id="entidad" class="mr-3 form-control form-control-sm col-12">
                ...
                <table class="display responsive nowrap" id="tablaListado" style="width:100%">
                    <thead>
                        <tr>
                            ...
                            <th>Inventario esta Confirmado</th>
                            <th>Acciones</th>
                        </tr>
                    </thead>
                </table>
...
@section('js')
    ...
    <script>
        ...
        var table;
        var buttons_data = {
            messageTop: 'inventarios registrados',
            messageBottom: 'Francisco Noceda',
            filename: 'inventarios',
            title: 'inventarios',
            table: 'tablaListado',
            newUrl: '{{ route('admin.inventario.form') }}',
        };
        var espanis_data = {
...
function eliminarme(id, _token , rutaDestroy){
        const swalWithBootstrapButtons = Swal.mixin({
          ...
          swalWithBootstrapButtons.fire({
            ...
            text: "Estas seguro de emilar El inventario",
            html: "",
            icon: 'warning',
        ...
        function formatDetalles ( d ) {
            ...
            html += '<thead><tr><th>&nbsp;</th><th>Codigo</th><th>Articulo</th><th>Cantidad</th></tr></thead>';
            html += '<tbody>';
            d.detalles.forEach(function(valor, indice, array){
                html += '<tr>';
                html += '<td>&nbsp;</td>';
                html += '<td>'+valor.articulo_id+'</td>';
        ...
        function getListado(){
            var _url = 'inventarios/datatable?desde='+$('#desde').val()+'&hasta='+$('#hasta').val()+'&entidad='+$('#entidad').val();
            ...
            var childRows = null;
             ...
             table = $('#tablaListado').DataTable({
                 ...
                 columns: [
                    ...
                    { "data": "name", "title":"Nombre Inventario", "className": 'details-control', width: '150px' },
                    { "data": "entidad.name", "title":"Entidad", "className":"details-control" },
                    { "data": "sucursal.name", "title":"Sucursal", "className":"details-control" },
                    { "data": "deposito.name", "title":"Deposito", "className":"details-control" },
                    { "data": "tipo_movimiento", "title":"Tipo de movimiento", "className":"details-control" , class: 'noexport, dt-center'},
                    { "data": "es_confirmado", "title":"Confirmado", "className":"dt-right details-control"  ,class: 'noexport, dt-center' },
